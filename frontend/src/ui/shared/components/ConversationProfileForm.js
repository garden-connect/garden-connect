...
export const ConversationProfileForm = ({props}) => {
...
console.log(props)
    ...
    const submitConversation = (values, {resetForm, setStatus}) => {
        ...
        const conversationSendProfileId = auth.profileId
        const conversationReceiveProfileId = props.profileId
        const conversationPostId = props.postId
